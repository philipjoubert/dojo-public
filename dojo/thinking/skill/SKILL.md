...
description: |
  ...
  Loaded: Shane Parrish (clear thinking, four defaults, five safeguards, premortem, first principles, inversion, second-order thinking, circle of competence, probabilistic thinking); Julia Galef (scout vs soldier mindset, calibration, surprise journaling, thought experiments for bias, equivalent-bet test, ideological Turing test); Hamilton Helmer (competitive strategy, 7 Powers — Scale/Network Economies, Counter-Positioning, Switching Costs, Branding, Cornered Resource, Process Power; Benefit/Barrier; 3 S's; Power Progression; why AI moats fail); Charlie Munger (latticework of mental models, invert-always-invert, 25 causes of misjudgment, lollapalooza effect, circle of competence, two-track analysis, incentive-caused bias, margin of safety, avoiding stupidity, evaluating businesses and people). More experts added over time.
---
