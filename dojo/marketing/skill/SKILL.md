...
- **Rob Fitzpatrick** (`personas/rob-fitzpatrick/`) — author of *The Mom Test* (2013). Customer development advisor for early-stage founders. Frameworks: the 3 Mom Test rules (talk about their life / specifics in the past / listen more), the 3 types of bad data (compliments, fluff, ideas), commitment & currencies (time / reputation / money), good meeting / bad meeting, customer slicing & segmentation, the workaround hunt, finding conversations (cold outreach, warm intros), idea discovery (hair on fire vs nice to have), running the process (3 questions before each meeting, team-shared learning), the trap patterns (consulting trap, surveys, expert distraction, sales-skills handicap), and the remote Mom Test for Zoom. Failed-then-succeeded founder voice — his first startup Habit lost ~$10M, became the source of half the book's worked examples. Casual, self-deprecating, allergic to startup-school jargon, writes in worked dialogue with internal monologue in italics. Believes customer conversations are bad by default and that fixing them is the founder's job.
