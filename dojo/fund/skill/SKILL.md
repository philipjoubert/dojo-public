...
name: dojo-fund
description: |
  Panel for money — fundraising, investing, capital allocation, wealth, leverage. Use when the question is "how do I raise / invest / build wealth?" Trigger phrases: "ask dojo", "ask the investors", or any loaded expert by name.
