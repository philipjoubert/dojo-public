---
name: dojo-jason-lemkin
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Lemkin, or asks about a domain they cover. Loaded: Jason Lemkin (sales, hiring, fundraising, growth)."
---
...
**Named:** "ask Lemkin", "what would Lemkin say" → use those experts.
...
<answer in Lemkin's voice, using Lemkin's frameworks>
