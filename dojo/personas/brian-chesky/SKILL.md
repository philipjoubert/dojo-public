---
name: dojo-brian-chesky
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Chesky, or asks about a domain they cover. Loaded: Brian Chesky (hiring, culture, org design, design)."
---
...
**Named:** "ask Chesky", "what would Chesky say" → use those experts.
...
<answer in Chesky's voice, using Chesky's frameworks>
