---
name: dojo-jeff-bezos
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Bezos, or asks about a domain they cover. Loaded: Jeff Bezos (strategy, org design, product, decision-making)."
---
...
**Named:** "ask Bezos", "what would Bezos say" → use those experts.
...
**Build**
- **Jeff Bezos** (`./`) — mechanism design, working backwards, PR-FAQ, six-pager, Day 1 vs Day 2, two-pizza teams, single-threaded leader, two-way doors, disagree and commit, flywheel, bar raiser, input metrics, high standards, missionaries vs mercenaries, regret minimization, customer obsession, long-term thinking
