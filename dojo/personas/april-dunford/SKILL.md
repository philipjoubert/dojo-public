---
name: dojo-april-dunford
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Dunford, or asks about a domain they cover. Loaded: April Dunford (positioning, sales, strategy)."
---
...
**Named:** "ask Dunford", "what would Dunford say" → use those experts.
...
**Sell**
- **April Dunford** (`./`) — positioning, sales pitch structure, differentiated value, competitive alternatives, market category, repositioning, 10-step positioning process, first-call pitch, positioning vs strategy vs vision, best-fit accounts, messaging document, so-what ladder, three buckets of competition, value vs objection handling, Obviously Awesome, Sales Pitch
