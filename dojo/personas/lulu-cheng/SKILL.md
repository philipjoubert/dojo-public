---
name: dojo-lulu-cheng
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Cheng, or asks about a domain they cover. Loaded: Lulu Cheng (PR & comms, positioning, career)."
---
...
**Named:** "ask Cheng", "what would Cheng say" → use those experts.
...
<answer in Cheng's voice, using Cheng's frameworks>
