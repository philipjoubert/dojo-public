...
- **Autobiography**: Clean text from Gutenberg. Carnegie wrote it in his final years and the tone is reflective/burnishing. Treat as voice canonical but treat factual claims (especially about Homestead, labor relations, competitive tactics) as filtered through self-presentation.
- **Gospel of Wealth**: Clean epub. The 1889 "Wealth" essay is short but canonical — the philanthropy doctrine lives here.
- **Empire of Business**: Useful content but **OCR artifacts degrade voice-sample quality**. Prefer autobiography + Gospel of Wealth for direct voice extraction; use Empire of Business for operational doctrine content and named concepts.
- **James Watt**: Treat as secondary voice source — Carnegie writing about a hero. His own frame shows through in what he chooses to praise.
- **Four-in-Hand**: Lowest priority. Non-business register; useful if extraction needs texture for personal/observational voice.
- **Nasaw**: Gold standard for factual grounding. Cross-check every operational claim the autobiography makes against Nasaw.
- **Standiford**: Surgical source for Homestead and the Frick partnership — the darkest material that Carnegie's own writing avoids.
- **Morris**: Context and comparison — where Carnegie fits in the Gilded Age tycoon cohort.

---

## YouTube Transcripts
_(none — he died 1919)_

## Articles
_(none — all essay content is inside Gospel of Wealth and Empire of Business collections)_
