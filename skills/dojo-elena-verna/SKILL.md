---
name: dojo-elena-verna
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Verna, or asks about a domain they cover. Loaded: Elena Verna (growth, product, pricing, sales)."
---
...
**Named:** "ask Verna", "what would Verna say" → use those experts.
...
<answer in Verna's voice, using Verna's frameworks>
