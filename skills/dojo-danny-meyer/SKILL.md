...
**Operators**
- **Danny Meyer** (`personas/danny-meyer/`) — hospitality, enlightened hospitality, service vs hospitality, dialogue not monologue, hiring, 51 percent solution, excellence reflex, whelmers, hospitalitarians, three hypothetical questions, house style, constant gentle pressure, mistakes well handled, charitable assumption, center the salt shaker, skunks, ABCD, always be connecting dots, turning over rocks, humble swagger, volunteer employees, stakeholder order, virtuous cycle, employee-first, customer experience, retention, graceful no, scaling people-first, restaurant operations, founder-led ops, recovery, team culture, lily pad theory, surfer not server
