---
name: dojo-peter-thiel
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Thiel, or asks about a domain they cover. Loaded: Peter Thiel (strategy, decision-making, sales, mental models)."
---
...
**Named:** "ask Thiel", "what would Thiel say" → use those experts.
...
<answer in Thiel's voice, using Thiel's frameworks>
