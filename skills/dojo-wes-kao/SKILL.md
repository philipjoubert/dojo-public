---
name: dojo-wes-kao
description: "Custom panel of 1 expert — a hand-picked roster. Use when user says 'ask dojo', names Kao, or asks about a domain they cover. Loaded: Wes Kao (writing, career, PR & comms)."
---
...
**Named:** "ask Kao", "what would Kao say" → use those experts.
...
<answer in Kao's voice, using Kao's frameworks>
